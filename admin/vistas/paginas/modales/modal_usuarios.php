    ...
    <div class="modal-content">
      <form method="post" id="Form_usurios" autocomplete="off">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <button type="submit" class="btn miBoton" id="color_ofi">Guardar Usuario</button>
        </div>
        <?php
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="number" name="input_tel_e" id="input_tel_e" class="form-control" placeholder="TELÉFONO" required>
            </div>
