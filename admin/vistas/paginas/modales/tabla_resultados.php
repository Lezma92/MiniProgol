                        ...
                        <?php foreach ($encuentros as $key => $encuentro) { ?>
                            <div class="col-md-4">
                                <p class="text-dark mt-0 text-center font-weight-bold" style="font-size: 16px;">
                                    ...
                                    echo ('<img height="30px" width="30px" src="' . $encuentro["img_local"] . '" alt="Card image cap"> </span>');
                                    echo ("  " . $encuentro["eq_local"] . "  vs  " . $encuentro["eq_visi"] . " ");
                                    echo ('<span><img height="30px" width="30px" src="' . $encuentro["img_visi"] . '" alt="Card image cap"> </span>');
                                    ?>
                                    <br>
                                    <?php
