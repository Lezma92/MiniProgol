                    ...
                    <tr class="text-center text-left">
                        ...
                        <td class="">
                            <span class="mr-0 mr-md-2 mr-sm">
                                <img height="34px" width="32px" src="<?php echo ($value["url_img_local"]); ?>" alt="Card image cap">
                            </span>
                        ...
                        <td>
                            <span class="mr-0 mr-md-2 mr-sm">
                                <img height="34px" width="32px" src="<?php echo ($value["url_img_visi"]); ?>" alt="Card image cap">
                            </span>
                            <label class="form-check-label">
