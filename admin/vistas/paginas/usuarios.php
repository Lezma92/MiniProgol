        ...
        <div class="card card-warning card-outline">
            ...
            <div class="card-body pad table-responsive">
             ...
             <?php
              ...
              $usuarios =ControladorUsuarios2::ctrlMostrarUsuarios("tipo_usuario", "Administrador","Activos");
                  ...
                  echo ' <tr>
                          ...
                          <td>
                            ...
                            <div class="btn-group">
                              ...
                              <button class="btn btn-danger btnEliminarUsuario" estoyEn = "1" idUsuario="'.$value["id"].'" usuario="'.$value["usuario"].'"><i class="fa fa-times"></i></button>
