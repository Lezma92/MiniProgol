                        ...
                        for ($header = 0; $header < 2; $header++) {
                            ...
                            if ($header == "1") {
                                ...
                                foreach ($vistaEncuentros as $key => $value) {
                                    ...
                                    $img_eq_local = $value["url_img_local"];
                                    $img_eq_visit = $value["url_img_visi"];

                                    for ($encuentros = 0; $encuentros < 2; $encuentros++) {
                                        $eq_local = $value['equipo_local'];
                                        if (strlen($value['equipo_local']) > 13) {
                                        ...
                                        if (strlen($value['equipo_visitante']) > 13) {
        ...
        for ($titulos = 0; $titulos < 2; $titulos++) {
            ...
            if ($titulos == "1") {
                ...
                for ($tel = 0; $tel < 2; $tel++) {
                    ...
                    $pdf->Cell(42, 3.5, utf8_decode('Pag: https://miniprogol.com'), "LB", 0, 'L');
                    $pdf->Cell(24, 3.5, 'Info: 7421107368', "RB", 0, 'L');

                    ////
                    if ($tel == "1") {
                        $pdf->Cell(42, 3.5, utf8_decode('Pag: https://miniprogol.com'), "LB", 0, 'L');
                        $pdf->Cell(24, 3.5, 'Info: 7421107368', "RB", 1, 'L');
                        $pdf->SetTextColor(19, 15, 14);
                    }
                }
            }
