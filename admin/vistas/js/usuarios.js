...
$(".tablas").on("click", ".btnEditarUsuario", function () {
  ...
  $.ajax({
    ...
    success: function (respuesta) {
      ...
      $("#input_apps_user_E").val(respuesta["app_s"]);
      $("#input_tel_e").val(respuesta["tel"]);
      $("#input_user_E").val(respuesta["usuario"]);
      $("#input_perfil_Ed").html(respuesta["tipo_usuario"]);
      $("#input_perfil_Ed").val(respuesta["tipo_usuario"]);
    }
...
formUser.addEventListener("submit", e => {
  ...
  if (app_user.value == "") {
    $("#input_apps_user").parent().after('<div class="alert alert-danger alert_app">Ingrese su apellido</div>');
    guardar = true;
    console.log(1);
  }

  if (usuario_user.value == "") {
    $("#input_user").parent().after('<div class="alert alert-danger alert_user">Favor de ingresar un nick</div>');
    guardar = true;
    console.log(2);
  }
  if (pass_user.value == "") {
    $("#input_pass").parent().after('<div class="alert alert-danger alert_pass">Ingrese su apellido</div>');
    guardar = true;
    console.log(1);
  }
