                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5 text-right">
                                        <div class="form-check form-check-inline">
                                            <span>
                                                <img src="<?php echo ($value["url_img_local"]); ?>" width="30" height="30">
                                            </span>
                                    ...
                                    <div class="col-5 text-left">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <span class="mr-0 mr-md-2">
                                                <img src="<?php echo ($value["url_img_visi"]); ?>" width="30" height="30">
                                            </span>
                                        </div>
                                    </div>
...
<script src="js/quinielas.js">
</script>
<?php
echo ("<script>cargarMisQuinielas(" . $id_jornada . "," . $id_liga . ");</script>");
?>